package com.abarigena.matchconsents.config;
...
public class KafkaConfiguration {
    ...
    public static final String MATCH_RESULT_TOPIC = "match-result";
    ...
    public ConsumerFactory<String, NotificationRequestDTO> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.commondto.dto");
    ...
    public NewTopic matchResultTopic() {
        return TopicBuilder.name(MATCH_RESULT_TOPIC)
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic notificationRequestTopic() {
        return TopicBuilder.name(NOTIFICATION_REQUEST_TOPIC)
                .partitions(3)
                .replicas(1)
                .build();
    }
