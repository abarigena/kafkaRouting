package com.abarigena.request_kafka.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, RequestDTO> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "req_consumer");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.commondto.dto");
